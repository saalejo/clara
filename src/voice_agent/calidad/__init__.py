...
Pipecat, el LLM y las herramientas. Conversa contra el mismo cerebro que atienden
los jueces —prompt de sistema, RAG y herramientas reales— pero por texto, para
poder ensayar los ataques (inyección, hostilidad, banderas rojas…) a solas antes
de la demo y medir cómo responde.
